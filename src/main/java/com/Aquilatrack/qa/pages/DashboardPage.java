...
public class DashboardPage extends TestBase {
	...
	Xls_Reader reader = new Xls_Reader(
			"C:\\Eclipse WorkSpace\\Aquilatrack_Portal\\src\\main\\java\\com\\Aquiltrack\\qa\\TestData\\dashboard.xlsx");
	...
	public void checkofflinevhcl() throws InterruptedException {
		offline.click();

		String offline = reader.getCellData("offline", "Search Offline Vehicles", 2);
		System.out.println(offline);

		searchbox.click();
		searchbox.sendKeys(offline);
		Thread.sleep(2000);
		vehiclepath.click();
		Thread.sleep(2000);
		backbtn.click();
