...
public class Alertconfigtestcases extends TestBase {
	...
	@Test(priority = 5)
	public void NoResponse_ALert() throws InterruptedException {
	...
	@Test(priority = 14)
	public void Refuel_Alert() throws InterruptedException {
...
//------------------------------------Conditional_ALert
	@Test(priority = 15)
	public void Conditional_Alert() throws InterruptedException {
...
//------------------------------------------Pilferage_Alert
	@Test(priority = 16)
	public void Pilferage_Alert() throws InterruptedException {
