...
public class DashboardPage extends TestBase {
	...
	@FindBy(xpath = "//*[@id=\"root\"]/div/div/main/div/div/div[2]/div/div[2]/div/div[1]/div[1]/div[1]/div[2]/div/div[2]/span/span[1]/span[1]")
	WebElement toggle;
	...
	public String SearchedResuktAtCurrentSummaryPage()
		...
		String Search_Data = Searched_Data();
		Search_Text_Field.sendKeys(Search_Data);
		// System.out.println(Searched_Data());
		// --//td[contains(text(),'434343434')]
		// actions.moveToElement(driver.findElement(By.xpath("//span[text()='" + hour +
		// "']"))).click().perform();
		...
		return driver.findElement(By.xpath("//td[contains(text(),'" + Search_Data + "')]")).getText();
	}
