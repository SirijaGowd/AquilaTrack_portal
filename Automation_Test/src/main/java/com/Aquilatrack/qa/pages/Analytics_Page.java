...
public class Analytics_Page extends TestBase {
	...
	Util_WAITS.waitForElementToBeVisible(driver, Fleet_Utlization_vehicle, 10).sendKeys("145142752623");
	Thread.sleep(1000);
    }
	...
	Util_WAITS.waitForElementToBeVisible(driver, Idle_Vehicle, 10).sendKeys("145142752623");
	Thread.sleep(2000);
    }
    ...
    public void halt_vehicle() throws InterruptedException, SQLException, ClassNotFoundException {
	...
	Util_WAITS.waitForElementToBeVisible(driver, Halt_Vehicle, 10).sendKeys(vehicleno);
	Thread.sleep(2000);
    }
    ...
    public void no_gps_vehicle() throws InterruptedException, ClassNotFoundException, SQLException {
    	Statement stmt=MysqlConnection.setup().createStatement();
	...
	Util_WAITS.waitForElementToBeVisible(driver, No_Gps_Vehicle, 10).sendKeys(vehicleno);
	Thread.sleep(1000);
    }
    ...
    public void Offline_Vehicle() throws InterruptedException, ClassNotFoundException, SQLException {
    	Statement stmt=MysqlConnection.setup().createStatement();
	...
	Util_WAITS.waitForElementToBeVisible(driver, Offline_vehicle, 10).sendKeys(vehicleno);
	Thread.sleep(1000);
    }
	...
	Util_WAITS.waitForElementToBeVisible(driver, Running_Vehicle, 10).sendKeys("145142752623");
	Thread.sleep(1000);
    }
