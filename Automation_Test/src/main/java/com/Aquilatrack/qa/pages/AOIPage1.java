...
public class AOIPage1 extends TestBase {
	Xls_Reader reader = new Xls_Reader("./src/main/java/com/Aquiltrack/qa/TestData/AOI.xlsx");
	...
	public void createAOIUsingCircleAndPlaces() throws InterruptedException, ClassNotFoundException, SQLException {
		...
		// return Util_WAITS.waitForElementToBEClickable(driver, AOI_Success_Msg,
		// 20).getText();
	...
	public void createAOIUsingPolygonAndPlaces() throws InterruptedException, ClassNotFoundException, SQLException {
	...
	public String clickAtSerachedAOI() throws ClassNotFoundException, SQLException {
		...
		ResultSet rs = stmt.executeQuery("select * from test_automation.AOI");
