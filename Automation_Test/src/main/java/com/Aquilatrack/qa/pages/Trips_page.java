...
public class Trips_page extends TestBase {
	...
	@FindBy(xpath = "(//input[@id='downshift-6-input'])[1]")
	WebElement create_trip_src_vehicle;

	public void trip_create() throws InterruptedException, ClassNotFoundException, SQLException, AWTException {

		Util_WAITS.waitForElementToBEClickable(driver, create_trip_tab, 10);

		Util_WAITS.waitForElementToBEClickable(driver, create_trip_src_vehicle, 20).click();
	}
}